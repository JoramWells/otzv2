...
const PatientLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  if (
    ...
    pathname === '/users/patients/tab/appointments' ||
    pathname === '/users/patients/tab/caregivers' ||
    pathname === '/users/patients/tab/casemanagers' ||
    pathname === '/users/patients/tab/homevisit' ||
    pathname === '/users/patients/tab/lab' ||
    pathname === '/users/patients/tab/pharmacy' ||
    pathname === '/users/patients/tab/medications' ||
    pathname === '/users/patients/tab/messages' ||
    pathname === '/users/patients/tab/settings' ||
    pathname === '/users/patients/tab/insights'
  ) {
    return (
